 ...
 */
const Home = () => {
	const { topAnimes, recentAnimes, popularAnimes, shonenAnimes } = useContext(AnimeListContext);
	...
	if (!topAnimes || !recentAnimes || !popularAnimes || !shonenAnimes) {
		return <CircularProg />;
	}
	...
	return (
		<Wrapper>
			...
			<AnimeSlider list={shonenAnimes} title={"Shounen Anime"} />
		</Wrapper>
	);
};
